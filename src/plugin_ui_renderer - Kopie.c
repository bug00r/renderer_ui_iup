...
static Ihandle * create_render_rotation_options_frame()
{
	...
	Ihandle *frame = IupFrame(IupHbox(rotx_container, roty_container, rotz_container, NULL));
...
Ihandle * create_and_show_dialog()
{
	...
	Ihandle * maindlg = IupVbox(
						render_frame, 
						render_zoom_options_frame,
						render_rotation_options_frame,
						NULL);
	return maindlg;
}
